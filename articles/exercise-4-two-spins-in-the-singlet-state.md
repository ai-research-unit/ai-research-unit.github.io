...
The first three exercises treated a single qubit: a single measurement (Exercise 1), time evolution (Exercise 2), and successive measurements (Exercise 3). This fourth exercise treats a **two-qubit system**, and introduces the first genuinely quantum-mechanical correlation: **entanglement**.
...
## Comparison with Exercises 1, 2, 3
...
The four exercises illustrate four fundamental operations of the quantum formalism: **measurement** (Exercise 1), **evolution** (Exercise 2), **sequential measurement** (Exercise 3), and **entangled measurement** (Exercise 4). In each case, the biquaternion framework expresses the operation as an algebraic manipulation of the elements of $\mathbb{M}_+$ and $\mathbb{H}_\mathbb{B}$ (and, in Exercise 4, their tensor products).
...
- The companion articles of this series: *Quantum Mechanics in Biquaternionic Form*, *Spin-1/2 Quantum Mechanics in Biquaternionic Form*, *Exercise 1: Measuring Spin Along an Arbitrary Direction*, *Exercise 2: Spin Precession in a Magnetic Field*, and *Exercise 3: Successive Measurements of Spin*.
