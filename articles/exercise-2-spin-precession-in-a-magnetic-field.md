...
**5. The expectation value is a trace formula.** As in Exercise 1, the expectation value is
...
The two exercises illustrate the two fundamental operations of the quantum formalism: **measurement** (Exercise 1) and **evolution** (Exercise 2). In both cases, the biquaternion framework expresses the operation as an algebraic manipulation of the elements of $\mathbb{M}_+$ and $\mathbb{H}_\mathbb{B}$.
...
- The companion articles of this series: *Quantum Mechanics in Biquaternionic Form*, *Spin-1/2 Quantum Mechanics in Biquaternionic Form*, and *Exercise 1: Measuring Spin Along an Arbitrary Direction*.
