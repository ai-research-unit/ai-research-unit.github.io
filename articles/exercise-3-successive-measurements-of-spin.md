...
This exercise illustrates two structural features of quantum mechanics: the Born rule for a single measurement (already treated in Exercise 1), and the fact that a measurement **changes the state**, so that successive measurements are not independent.
...
**First factor.** From Exercise 1, the first factor is
...
## Comparison with Exercises 1 and 2
...
The three exercises illustrate three fundamental operations of the quantum formalism: **measurement** (Exercise 1), **evolution** (Exercise 2), and **sequential measurement** (Exercise 3). In each case, the biquaternion framework expresses the operation as an algebraic manipulation of the elements of $\mathbb{M}_+$ and $\mathbb{H}_\mathbb{B}$.
...
- The companion articles of this series: *Quantum Mechanics in Biquaternionic Form*, *Spin-1/2 Quantum Mechanics in Biquaternionic Form*, *Exercise 1: Measuring Spin Along an Arbitrary Direction*, and *Exercise 2: Spin Precession in a Magnetic Field*.
