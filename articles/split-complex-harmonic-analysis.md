...
## The Split Complex Dirac Delta

### Definition

The **split complex Dirac delta** $\delta$ is the distribution
...
where $\delta_+$ and $\delta_-$ are the ordinary real Dirac deltas on the two light cone directions.
...
| $\delta$ | Split complex Dirac delta |
