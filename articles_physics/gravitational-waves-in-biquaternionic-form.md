# __Gravitational Waves in Biquaternionic Form__
...
$$
R_{0101} = -R_{0202} = \frac{\omega^2}{2c^2}\cos\!\left(\frac{\omega}{c}(z - ct)\right),
\qquad R_{0303} = 0,
$$
...
$$
R_{0102} = R_{0123} = \frac{\omega^2}{2c^2}\cos\!\left(\frac{\omega}{c}(z - ct)\right),
\qquad R_{0101} = R_{0202} = R_{0303} = 0 .
$$
...
$$
h_{ij}^{\mathrm{TT}}(t,\mathbf{x}) = \frac{2G}{c^4 r}\,\ddot{Q}_{ij}^{\mathrm{TT}}(t - r/c), \qquad
Q_{ij} = \int \rho(\mathbf{x}')\left(x'_ix'_j - \tfrac{1}{3}r'^2\delta_{ij}\right)d^3x',
$$
...
$$
Q_{xx} = \frac{mR^2}{3} + mR^2\cos 2\omega t, \qquad
Q_{yy} = \frac{mR^2}{3} - mR^2\cos 2\omega t, \qquad
Q_{xy} = mR^2\sin 2\omega t,
$$

whose third derivatives give $\dddot{Q}_{ij}\dddot{Q}_{ij} = 128\,m^2R^4\omega^6$, a constant. Then

$$
P = \frac{G}{5c^5}\cdot128\,m^2R^4\omega^6
= \frac{64}{5}\frac{G^4}{c^5}\frac{m^5}{d^5},
$$

on using Kepler's law $\omega^2 = 2Gm/d^3$ and $R = d/2$. The standard equal-mass form of the binary power is

$$
P = \frac{32}{5}\frac{G^4}{c^5}\frac{(m_1m_2)^2(m_1+m_2)}{d^5}
...
- Companion articles: *Linearized Gravity in Biquaternionic Form*; *Curved Spacetime and the Biquaternion Framework*; *Maxwell's Equations in the Biquaternionic Formulation*; *The Field-Strength Biquaternion and Its Invariants*; *Exercise: The Electromagnetic Energy–Momentum Tensor*; *The Anti-Hermitian Subspace $\mathbb{M}_-$ as the Material Sector*; *The Hermitian Subspace $\mathbb{M}_+$ as the Informational Sector*; *The Gauge Principle in Biquaternionic Form*; *The Relativistic Two-Body Problem in Biquaternionic Form*; *Radiation from Accelerated Charges in Biquaternionic Form*; *Twistor Theory and Biquaternions*; *Biquaternion Representation Theory*.
